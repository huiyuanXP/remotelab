...
function normalizeProvider(value, fallbackValue = 'cloudflare_worker') {
...
function attachFallbackMetadata(result, provider, error) {
  return {
    ...result,
    ...
    fallbackReason: firstNonEmpty(result?.fallbackReason, 'cloudflare_verified_destination_only'),
